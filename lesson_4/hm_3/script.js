...
// Можно было бы оптимизировать код тем, что данные хранить в объектах (стукртурировать), и сделать функцию для получения значения/вывода ошибки (у нас одни и те же действия повторяются)